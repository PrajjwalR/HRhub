        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-12 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#4A72FF] focus:border-transparent outline-none transition-all text-gray-900"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-[#4A72FF] text-white py-3 rounded-lg font-medium hover:bg-blue-600 transition-colors shadow-lg shadow-blue-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
